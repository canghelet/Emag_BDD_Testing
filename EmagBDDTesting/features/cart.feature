Feature: Emag cart feature
    ...
    Background:
      ...
      When home: I search after "iPhone 12, 64GB, Black"
      When products: I add product to basket "Telefon mobil Apple iPhone 12, 64GB, 5G, Black"
      When products: I click Vezi detalii cos

    @cart1
    Scenario: Test cart total sum functionality
      Then cart: I verify that total price is correct "2.649,99"
